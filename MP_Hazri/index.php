		...
		<div id="content1">
			<section class="row">
				...
				<h1 style="text-align:left;"> <u>Know Your MP</u>
					...
					<div class="right">
				<div class="facebookshare-box"><a name="fb_share" type="box_count" share_url="http://projects.iic.ac.in/nic/Lunatics/"></a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script></div>
<img  alt="" width="" height=""></a></h1>
					</div>
...
<div class="formRow">
			...
			<div class="right">
			&nbsp 
			<a href="https://github.com/deep1109/know_your_mp" target="_blank"> <img src="img/git.png" alt="git" width="30" height="30" ></a>
			<p>Git Link</p>
			</div>
			<div class="center">
				 <p> &copy; 2013, Some Rights Reserved. Developed and Maintained by Deepak Kumar Yadav and Deepanshu Jain</p></div>
		<div class="right">
	
		
		
		</footer>
		<script type="text/javascript">stLight.options({publisher: "21254121-7fc5-4305-aa1f-bac3fc612905", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
<script>
var options={ "publisher": "21254121-7fc5-4305-aa1f-bac3fc612905", "position": "left", "ad": { "visible": false, "openDelay": 5, "closeDelay": 0}, "chicklets": { "items": ["facebook", "twitter", "pinterest", "sharethis"]}};
